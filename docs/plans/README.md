...
| M5 | The detailed machine tier: algebraic bus voltages (a DAE), flux dynamics, a voltage regulator, power-flow initialisation, and the Iberian criterion the tier exists for | **In progress** — steps 0b and 1 done (the suite split; then the algebraic network, the power flow and the flat run — 2083 core / 172 UI / 82 reference); steps 2–8 open | `m5-*.md` (physics worked ahead in `m5-prestudy.md`) |
